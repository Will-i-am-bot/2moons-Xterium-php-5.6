<?php
// @description: Stellt eine weitere Erinnerungsrunde zu inaktiven Ressourcenwelten bereit
function runFleetEventInactive3()
{
    global $CONF, $UNI;
    ...
    $nextRun = $CONF['fleet_event_inactive_3'] + 60 * 60 * 24;
    $database->query("UPDATE " . CONFIG . " SET fleet_event_inactive_3 = '" . $nextRun . "' WHERE `uni` = '" . $UNI . "';");
    $CONF['fleet_event_inactive_3'] = $nextRun;
}
