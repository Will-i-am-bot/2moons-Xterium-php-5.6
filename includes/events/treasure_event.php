<?php
// @description: Füllt zufällige inaktive Planeten mit riesigen Ressourcenreserven
function runTreasureEvent()
{
    global $CONF, $UNI;
    ...
    $newEventTime = $CONF['treasure_event'] + 60 * 60 * 24;
    $database->query("UPDATE " . CONFIG . " SET treasure_event = '" . $newEventTime . "' WHERE `uni` = '" . $UNI . "';");

    $CONF['treasure_event'] = $newEventTime;
}
