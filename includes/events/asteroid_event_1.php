<?php
// @description: Löst die alternative Asteroidenrunde mit identischen Belohnungen aus
function runAsteroidEvent1()
{
    global $CONF, $UNI;
    ...
    $newTime = $CONF['asteroid_event_1'] + 60 * 60 * 24;
    $database->query("UPDATE " . CONFIG . " SET asteroid_event_1 = '" . $newTime . "' WHERE `uni` = '" . $UNI . "';");
    $CONF['asteroid_event_1'] = $newTime;
}
